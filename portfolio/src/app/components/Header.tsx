...
export default function Header() {
    return (
        <header className="fixed top-0 left-0 w-full bg-neutral-950/80 hover:bg-neutral-950/100 backdrop-blur border-neutral-900 fade-in-delayed transition-colors duration-300 opacity-0">
